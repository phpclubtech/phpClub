...
class Version20170402190438 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE files ADD id INT AUTO_INCREMENT NOT NULL, CHANGE post post INT NOT NULL, CHANGE displayname displayname VARCHAR(255) NOT NULL, CHANGE duration duration TIME DEFAULT NULL, CHANGE fullname fullname VARCHAR(255) NOT NULL, CHANGE height height INT NOT NULL, CHANGE md5 md5 VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE nsfw nsfw INT NOT NULL, CHANGE size size INT NOT NULL, CHANGE tn_height tn_height INT NOT NULL, CHANGE tn_width tn_width INT NOT NULL, CHANGE type type INT NOT NULL, CHANGE width width INT NOT NULL, ADD PRIMARY KEY (id)');
