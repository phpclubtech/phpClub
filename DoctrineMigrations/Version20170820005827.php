 ...
 */
class Version20170820005827 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE post (id INT NOT NULL, thread_id INT DEFAULT NULL, text LONGTEXT NOT NULL, date VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, is_op_post TINYINT(1) NOT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, INDEX IDX_5A8A6C8DE2904019 (thread_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, post_id INT DEFAULT NULL, relative_path VARCHAR(255) DEFAULT NULL, thumbnail_relative_path VARCHAR(255) DEFAULT NULL, remote_url VARCHAR(255) DEFAULT NULL, thumbnail_remote_url VARCHAR(255) DEFAULT NULL, size INT NOT NULL, width INT NOT NULL, height INT NOT NULL, INDEX IDX_8C9F36104B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
